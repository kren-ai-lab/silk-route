...
def run_compound(
    ...
    only_ontology_parents: bool = typer.Option(False, "--only-parents", help="If true, only fetch ontology parents"),
    only_ontology_children: bool = typer.Option(False, "--only-children", help="If true, only fetch ontology children"),
...
def run_compounds(
    chebi_ids: str = typer.Argument(..., help="Comma-separated list of ChEBI IDs (e.g., CHEBI:15377,CHEBI:15378)"),
    output: str = typer.Option(None, help="Output file to save the results (optional)")
):
