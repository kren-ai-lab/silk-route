...
def get_query_builder_specs() -> dict[str, QueryBuilderSpec]:
    ...
    specs = [
        ...
        QueryBuilderSpec(
            key="chembl_ic50_activity",
            label="ChEMBL IC50 activity builder",
            description="ChEMBL IC50 activity macro builder with optional standard_units.",
            database="chembl",
        ...
        QueryBuilderSpec(
            ...
            description="ChEBI entity lookup and advanced search builder.",
            database="chebi",
            builder_type="resource_filter",
        ...
        QueryBuilderSpec(
            key="chebi_ontology",
            label="ChEBI ontology search builder",
            description="ChEBI ontology relation and term builder.",
            database="chebi",
            builder_type="paired_fields",
            build_friendly_query=build_chebi_friendly_query,
            build_interpreted_query=build_chebi_interpreted_query,
            get_field_catalog=partial(get_chebi_query_builder_field_catalog, "ontology"),
            compatible_modalities=("compound",),
            compatible_interaction_types=(None,),
        ),
        QueryBuilderSpec(
            key="chebi_structure",
            label="ChEBI structure search builder",
            description="ChEBI connectivity, substructure, and similarity builder.",
            database="chebi",
            builder_type="structure_search",
            build_friendly_query=build_chebi_friendly_query,
            build_interpreted_query=build_chebi_interpreted_query,
            get_field_catalog=partial(get_chebi_query_builder_field_catalog, "structure"),
            compatible_modalities=("compound",),
            compatible_interaction_types=(None,),
        ),
    ]
