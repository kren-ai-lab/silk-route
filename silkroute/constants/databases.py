...
BASE_CACHE_DIR = Path(os.getenv("SILKROUTE_CACHE_DIR") or user_cache_dir(APP_NAME)).expanduser()
BASE_BLAST_DB_DIR = BASE_CACHE_DIR / "blast_db"
BASE_CONFIG_DIR = Path(os.getenv("SILKROUTE_CONFIG_DIR") or user_config_dir(APP_NAME)).expanduser()
...
SABIORK = _db("sabiork", "https://sabiork.h-its.org/export-api/sabio/")
