...
from silkroute.core.workflow import schema as workflow_schema
from silkroute.core.workflow.main_workflow import MainWorkflow
from silkroute.logging import configure_logging, get_logger

log = get_logger("silkroute.cli.workflows")
...
def validate_workflow_recipe(recipe: dict) -> dict:
    ...
    :func:`silkroute.core.workflow.schema.validate_workflow_v1_descriptor`, then derives
...
def build_tool_identity() -> dict[str, str]:
    ...
    return {
        "tool_name": "SilkRoute",
        "distribution_name": "silkroute",
        "import_package_name": "silkroute",
        "version": __version__,
    }
...
def run_workflow(
    ...
    try:
        if workflow_values["debug"]:
            ...
            logger = get_logger("silkroute.cli.workflows")
