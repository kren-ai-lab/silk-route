...
``DBConfig`` cache directory from ``silkroute.constants.databases`` is registered
...
Example:
    from silkroute.core.cache import clear_cache, register_cache
...
from silkroute.constants import databases as db_consts
