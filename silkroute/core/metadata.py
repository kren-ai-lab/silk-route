...
Serialized shape::
    ...
    {
      "tool":       {"name": "silkroute", "version": "0.1.0"},
...
class ToolInfo:
    ...
    Attributes:
        name (str): Library name (e.g. ``"silkroute"``).
...
def current_tool() -> ToolInfo:
    ...
    imported during ``silkroute`` package initialization).
    """
    from silkroute import __version__  # noqa: PLC0415  # lazy to avoid a circular import

    return ToolInfo(name="silkroute", version=__version__)
