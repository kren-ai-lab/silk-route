...
from silkroute.constants.databases import BASE_CONFIG_DIR
...
def load_environment_files(config_dir: str | None = None) -> None:
    ...
    Checks, in order, ``SILKROUTE_ENV_FILE``, the current working directory, and
    ...
    env_file = os.getenv("SILKROUTE_ENV_FILE")
    if env_file:
