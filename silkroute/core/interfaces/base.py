...
from silkroute.core.interfacesconfig import load_packaged_config, read_config_file
from silkroute.core.metadata import FetchMetadata, RequestInfo, current_tool
from silkroute.core.utils.base_auxiliary_methods import get_nested, get_primary_keys, validate_parameters
...
class BaseAPIInterface(ABC):  # noqa: B024  # base by intent; fetch/parse have concrete defaults
    """Abstract base class for all SilkRoute API interfaces."""
    ...
    def _load_all_configs(self, config_dir: str) -> None:
        ...
        defaults, so interfaces work on a clean machine without ``silkroute-init``.
