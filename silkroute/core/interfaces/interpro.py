...
from silkroute.constants.databases import INTERPRO
from silkroute.constants.interpro import db_types, entry_integration_types, filter_types
from silkroute.core.exceptions import ConfigError
from silkroute.logging import get_logger

from .base import BaseAPIInterface

log = get_logger("silkroute.interfaces.interpro")
