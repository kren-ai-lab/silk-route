...
from silkroute.constants.databases import BIOGRID
...
log = get_logger("silkroute.interfaces.biogrid")

BIOGRID_ENV_VARS = ("SILKROUTE_BIOGRID_API_KEY",)
    ...
    def fetch(self, query: str | dict | list, *, method: str = "interactions", **kwargs: Any) -> dict | list:
        ...
        if isinstance(query, dict):
            ...
            if not is_valid_secret(query.get("accessKey")):
                msg = "Missing BioGRID API key. Set SILKROUTE_BIOGRID_API_KEY or pass api_key explicitly."
