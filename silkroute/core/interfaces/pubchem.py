...
from silkroute.constants.databases import PUBCHEM
from silkroute.constants.pubchem import COMPOUND_TEMPLATE, GENE_TEMPLATE, OPTIONS, PROTEIN_TEMPLATE
...
log = get_logger("silkroute.interfaces.pubchem")
