...
from silkroute.constants.databases import DATABASES, UNIPROT
...
from silkroute.core.utils.xmlhandler import dict_to_elementtree
from silkroute.logging import get_logger

log = get_logger("silkroute.interfaces.uniprot")
