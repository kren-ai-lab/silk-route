...
from silkroute.gui.form_helpers import (
...
from silkroute.gui.query_builders.chebi import (
...
from silkroute.gui.query_builders.pubchem import (
    build_pubchem_friendly_query,
    build_pubchem_interpreted_query,
)
from silkroute.gui.query_builders.registry import get_compatible_query_builder_choices
...
class WorkflowYamlBuilderApp:
    """Render and manage the SilkRoute workflow YAML builder."""
    ...
    def build(self) -> None:
        ...
        ui.page_title("SilkRoute Workflow YAML Builder")
        with ui.column().classes("w-full max-w-5xl mx-auto gap-4 p-4"):
            ui.label("SilkRoute Workflow YAML Builder").classes("text-2xl font-semibold")
            ui.label(
                "Use this page to prepare workflow-v1 YAML descriptors for SilkRoute. "
    ...
    def build_shared_query_controls(self) -> None:
        ...
        ui.label(
            ...
            "SilkRoute uses default UniProt fields: "
